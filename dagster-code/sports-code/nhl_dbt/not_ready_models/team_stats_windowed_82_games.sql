...
select
    ...
    sum(hg.home_pp_goals) as total_home_pp_goals,
    sum(hg.home_pp_opp) as total_home_pp_opps,
    sum(hg.home_faceoff_pct) as total_home_faceoff_pct,
    sum(hg.home_blocked) as total_home_blocked,
    sum(hg.home_takeaways) as total_home_takeaways,
    sum(hg.home_giveaways) as total_home_giveaways,
    sum(hg.home_hits) as total_home_hits,
    sum(hg.away_pp_goals) as total_home_opp_pp_goals,
    sum(hg.away_pp_opp) as total_home_opp_pp_opps,
    sum(hg.away_faceoff_pct) as total_home_opp_faceoff_pct,
    sum(hg.away_blocked) as total_home_opp_blocked,
    sum(hg.away_takeaways) as total_home_opp_takeaways,
    sum(hg.away_giveaways) as total_home_opp_giveaways,
    sum(hg.away_hits) as total_home_opp_hits
from game_teams ts
...
select
    ...
    sum(hg.away_pp_goals) as total_away_pp_goals,
    sum(hg.away_pp_opp) as total_away_pp_opps,
    sum(hg.away_faceoff_pct) as total_away_faceoff_pct,
    sum(hg.away_blocked) as total_away_blocked,
    sum(hg.away_takeaways) as total_away_takeaways,
    sum(hg.away_giveaways) as total_away_giveaways,
    sum(hg.away_hits) as total_away_hits,
    sum(hg.home_pp_goals) as total_away_opp_pp_goals,
    sum(hg.home_pp_opp) as total_away_opp_pp_opps,
    sum(hg.home_faceoff_pct) as total_away_opp_faceoff_pct,
    sum(hg.home_blocked) as total_away_opp_blocked,
    sum(hg.home_takeaways) as total_away_opp_takeaways,
    sum(hg.home_giveaways) as total_away_opp_giveaways,
    sum(hg.home_hits) as total_away_opp_hits
from game_teams ts
...
select
        ...
        total_home_pp_opps,
        total_away_pp_opps,
        total_home_faceoff_pct,
        total_away_faceoff_pct,
        total_home_blocked,
        total_away_blocked,
        total_home_takeaways,
        total_away_takeaways,
        total_home_giveaways,
        total_away_giveaways,
        total_home_hits,
        total_away_hits,
        total_home_opp_pp_goals,
        total_away_opp_pp_goals,
        total_home_opp_pp_opps,
        total_away_opp_pp_opps,
        total_home_opp_faceoff_pct,
        total_away_opp_faceoff_pct,
        total_home_opp_blocked,
        total_away_opp_blocked,
        total_home_opp_takeaways,
        total_away_opp_takeaways,
        total_home_opp_giveaways,
        total_away_opp_giveaways,
        total_home_opp_hits,
        total_away_opp_hits
from game_teams ts
