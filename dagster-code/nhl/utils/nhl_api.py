    ...
    for date_data in data['dates']:
        for game in date_data['games']:
            schedule.append({
                ...
                "home_ties_date": game["teams"]["home"]["leagueRecord"].get("ties", 0),
                "away_team": game["teams"]["away"]["team"]["name"],
                "away_wins_date": game["teams"]["away"]["leagueRecord"]["wins"],
                "away_losses_date": game["teams"]["away"]["leagueRecord"]["losses"],
                "away_ties_date": game["teams"]["away"]["leagueRecord"].get("ties", 0),
...
def get_team_stats(game_id):
    ...
    column_name_mapping = {'faceOffWinPercentage': 'faceoff_pct',
